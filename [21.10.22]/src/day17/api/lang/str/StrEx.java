...
public class StrEx {
    ...
    public static void main(String[] args) {
        ...
        int first = str.indexOf("l");///앞에서부터 검색 앞에 있는 l
        int last = str.lastIndexOf("l");///뒤에서부터 검색 뒤에 있는 l
        ...
        //파일경로에서 확장자 추출
        String filePath = "C:/local/img/2021/09/17/메롱.jpg";///. 다음 글자부터
